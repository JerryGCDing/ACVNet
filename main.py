...
parser.add_argument('--datapath', default="/work/vig/Datasets/DrivingStereo", help='data path')
parser.add_argument('--trainlist', default='/work/vig/tianyed/ACVNet/ACVNet/filenames/DS_train.txt', help='training list')
parser.add_argument('--testlist',default='/work/vig/tianyed/ACVNet/ACVNet/filenames/DS_test.txt', help='testing list')
